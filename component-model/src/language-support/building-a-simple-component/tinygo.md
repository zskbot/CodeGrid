> [!WARNING]
> The component model tools for TinyGo are not currently being maintained.
> We recommend using the [Go tooling](./go.md) instead.
...
```wit
{{#include ../../../examples/tutorial/tinygo/adder/world2.wit}}
```
...
```Go
{{#include ../../../examples/tutorial/tinygo/adder/main.go}}
```
